export const emailErrorMsg = 'Введите почту в формате hurrles@mail.ru';
export const passwordErrorMsg = 'Введите пароль содержащий a-zA-Z0-9!?*-()+=';
export const repeatPasswordErrorMsg = 'Пароли не совпадают';
export const loginFormErrorMsg = 'Не верный логин или пароль';
...
export const floorsErrorMsg = 'Введите количество этажей в ресторане';
